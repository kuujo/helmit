...
func NewForResources(namespace string, resources helmkube.ResourceList) ({{ .Types.Interface }}, error) {
	kubernetesConfig, err := config.GetRestConfig()
	if err != nil {
		return nil, err
	}
...
func NewForResourcesOrDie(namespace string, resources helmkube.ResourceList) {{ .Types.Interface }} {
